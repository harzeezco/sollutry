...
[![Twitter Follow](https://img.shields.io/twitter/follow/codewithsadee_?style=social)](https://twitter.com/intent/follow?screen_name=codewithsadee_)
  ...
  <a href="https://sollutry.vercel.app"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/harzeezco/sollutry.git
```

Windows:

```bash
git clone https://github.com/harzeezco/sollutry.git
```
